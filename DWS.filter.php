...
{
    protected $sDescription = 'Filter the code to make it compatible with DWS Coding Standards';
    private $iNestedStringIndex = 0;
    ...
    {
        if (!$this->oBeaut->getMode('double_quote') && $this->iNestedStringIndex > 0) {
            $this->iNestedStringIndex--;
